            ...
            <?php
                ...
                while($row = mysqli_fetch_array($query_run))
                {
                    ...
                    <tr>
                        ...
                        <td><?php echo '<img src="data:image;base64,'.base64_encode($row['element']).'" alt="Image" style="width: 100px; height:100px"'; ?></td>
                        <td><?php echo '<img src="data:image;base64,'.base64_encode($row['senjata']).'" alt="Image" style="width: 100px; height:100px"'; ?></td>
                    </tr>
                    <?php
                }
            ?>
